...
file_path_valencia = "Valencia.xlsx"
...
X_train, X_test, y_train, y_test = train_test_split(X_total_poly, y_total, test_size=0.1, random_state=42)
...
print(f"Resultados combinados Madrid+Valencia (10% Test):")
print(f"MAE: {mae:.2f}")
print(f"MSE: {mse:.2f}")
